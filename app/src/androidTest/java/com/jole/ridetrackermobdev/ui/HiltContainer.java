...
public class HiltContainer {
    ...
    public static <A extends FragmentActivity, F extends Fragment> void launchFragmentInHiltContainer(
        ...
        launchFragmentInHiltContainer(activityClass, fragmentClass, fragmentArgs, R.style.Theme_RideTrackerMobDev);
    }



    public static <A extends FragmentActivity, F extends Fragment> void launchFragmentInHiltContainer(@NonNull Class<A> activityClass, @NonNull Class<F> fragmentClass, @Nullable Bundle fragmentArgs, @StringRes int themeResId) {
